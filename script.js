...
const zastepy = [
    ...
    { nazwa: 'Dragoni', punkty: 0 },
    { nazwa: 'Draco', punkty: 0 },
    { nazwa: 'Dzwonki', punkty: 0 },
    { nazwa: 'Filar', punkty: 0 },
    { nazwa: 'Fiołki', punkty: 0 },
    { nazwa: 'Forti Lupi', punkty: 0 },
    ...
    { nazwa: 'Orły', punkty: 0 },
    { nazwa: 'Pancernii', punkty: 0 },
    { nazwa: 'Petyhorcy', punkty: 0 },
    { nazwa: 'Prinus', punkty: 0 },
    { nazwa: 'Promienie', punkty: 0 },
    { nazwa: 'Rajtarzy', punkty: 0 },
    ...
    { nazwa: 'Sępy', punkty: 0 },
    { nazwa: 'Sorbus', punkty: 0 },
    { nazwa: 'Szafir', punkty: 0 },
